...
//
//	mockgen -source=src/model/user_domain_interface.go -destination=src/tests/mocks/user_domain_interface_mock.go -package=moks
//

// Package moks is a generated GoMock package.
package mocks
